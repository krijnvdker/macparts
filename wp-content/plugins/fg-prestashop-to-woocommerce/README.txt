...
It has been tested with **PrestaShop versions 1.0 to 1.7** and **WordPress 5.3**. It is compatible with multisite installations.
...
* Brands: imports the manufacturers or the suppliers
